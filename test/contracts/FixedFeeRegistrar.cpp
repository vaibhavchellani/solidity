...
contract FixedFeeRegistrar is Registrar {
	...
	function reserve(string _name) public payable {
	...
	function disown(string _name, address _refund) public onlyrecordowner(_name) {
	...
	function setAddr(string _name, address _a) public onlyrecordowner(_name) {
	...
	function record(string _name) public view returns (address o_addr, address o_subRegistrar, bytes32 o_content, address o_owner) {
		Record rec = m_record(_name);
		o_addr = rec.addr;
	...
	function addr(string _name) public view returns (address) { return m_record(_name).addr; }
	function subRegistrar(string _name) public view returns (address) { return m_record(_name).subRegistrar; }
	function content(string _name) public view returns (bytes32) { return m_record(_name).content; }
	function owner(string _name) public view returns (address) { return m_record(_name).owner; }
